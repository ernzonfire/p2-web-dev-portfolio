...
- GitLab source links for all five course projects
...
[View the deployed portfolio](https://p2-web-dev-portfolio.vercel.app/)
...
No build step is required. Serve the directory with any static server, then open the local URL in a browser.
...
The portfolio refinement is complete, and the five featured course projects from P2 through P6 are publicly deployed.
